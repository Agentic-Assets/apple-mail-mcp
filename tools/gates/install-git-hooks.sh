...
chmod +x "$ROOT/tools/gates/dev-check.sh" "$ROOT/tools/gates/pre-commit-validate.sh" "$ROOT/tools/gates/install-git-hooks.sh"
ln -sf ../../tools/gates/pre-commit-validate.sh "$HOOK"

echo "Installed pre-commit hook:"
echo "  $HOOK → tools/gates/pre-commit-validate.sh"
echo ""
...
echo ""
echo "Run manually: bash tools/gates/dev-check.sh"
