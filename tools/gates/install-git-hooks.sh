...
echo "  • validate_no_committed_identity.py — public-repo identity scan (always, runs first)"
echo "  • validate_manifests.sh (always)"
echo "  • validate_tasks_layout.py + validate_repo_root.py (always)"
echo "  • module line budget report + pytest + collected-test-count check (always)"
