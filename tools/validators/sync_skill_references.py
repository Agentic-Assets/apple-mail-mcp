...
SYNC_MAP: dict[str, list[str]] = {
    "apple-mail-operator": ["large-inbox-rules.md", "pre-draft-verification.md"],
    "inbox-triage": ["large-inbox-rules.md", "pre-draft-verification.md"],
    "email-management": ["large-inbox-rules.md", "pre-draft-verification.md"],
    "email-drafting": ["pre-draft-verification.md"],
