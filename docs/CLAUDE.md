...
Nine skills ship under [`plugin/skills/`](../plugin/skills/) and auto-load with the Claude Code plugin install. They teach **when** and **how** to call the 28 MCP tools — they do not implement tool logic.
