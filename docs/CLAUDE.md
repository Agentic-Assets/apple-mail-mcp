...
Nine skills ship under [`plugin/skills/`](../plugin/skills/) and auto-load with Claude Code and Codex plugin installs. They teach **when** and **how** to call the 28 MCP tools — they do not implement tool logic.
