...
For a true full-inbox analytics pass, see [`large-inbox-rules.md`](large-inbox-rules.md) — `get_statistics(scope="account_overview", days_back=0)` returns `UNBOUNDED_SCAN_REQUIRED`; use `full_inbox_export` only for annual / compliance work.
