...
| [`whose-elimination-2026-05-22/00-FINAL-SYNTHESIS.md`](whose-elimination-2026-05-22/00-FINAL-SYNTHESIS.md) | **Current workstream** — Phase A capability-token refactor (v3.2.0) + senior-review hardening pass (v3.2.1) shipped 2026-05-22; Envelope Index SQLite migration (Phase B v4.0.0) deferred 1-2 weeks | Phase A+v3.2.1 shipped; Phase B deferred |
