...
| [`active/v3.11.5-consolidated-release/`](active/v3.11.5-consolidated-release/) | Four-branch consolidation, cross-client marketplace hardening, and local release proof | Review-ready; combined PR and main merge pending |
