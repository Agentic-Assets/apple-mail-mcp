...
| [`cleanup-docs-and-simplify-2026-06-08/phase-plan.md`](cleanup-docs-and-simplify-2026-06-08/phase-plan.md) | Post-native-reply simplification plan: retire duplicate command surface, tighten docs, preserve validation | Active |
| [`cleanup-docs-and-simplify-2026-06-08/progress-log.md`](cleanup-docs-and-simplify-2026-06-08/progress-log.md) | Execution and verification evidence for the cleanup branch | Active |
| [`codex-claude-plugin-setup-2026-06-07/phase-plan.md`](codex-claude-plugin-setup-2026-06-07/phase-plan.md) | Codex + Claude plugin setup plan, based on Corbis reference research | Shipped on main; 3.6.1 release gate green |
| [`codex-claude-plugin-setup-2026-06-07/progress-log.md`](codex-claude-plugin-setup-2026-06-07/progress-log.md) | Discovery, execution, and verification evidence for cross-platform plugin setup | Shipped evidence |
| [`codex-claude-plugin-setup-2026-06-07/learnings-and-parking-lot.md`](codex-claude-plugin-setup-2026-06-07/learnings-and-parking-lot.md) | Durable packaging lessons and deferred cleanup items | Shipped sidecar |
| [`codex-mcp-tool-registration-incident-2026-06-08/issue-summary.md`](codex-mcp-tool-registration-incident-2026-06-08/issue-summary.md) | Incident summary for Codex plugin installed/enabled but Apple Mail MCP tools absent; fix and test plan for Claude plus Codex launcher compatibility | Shipped on main; runtime smoke green |
| [`codex-mcp-tool-registration-incident-2026-06-08/progress-log.md`](codex-mcp-tool-registration-incident-2026-06-08/progress-log.md) | Execution and verification evidence for Codex launcher/runtime-smoke fix | Shipped evidence |
| [`codex-mcp-tool-registration-incident-2026-06-08/native-reply-and-draft-lifecycle-issue.md`](codex-mcp-tool-registration-incident-2026-06-08/native-reply-and-draft-lifecycle-issue.md) | Resolution evidence for native Mail reply drafts and bounded Drafts lifecycle lookup | Shipped on main; live Mail smoke green |
...
| [`reply-draft-pr38-review-findings-2026-06-30.md`](reply-draft-pr38-review-findings-2026-06-30.md) | Review findings and before-merge todo list for PR #38 reply draft verification, signatures, exact-id proof, and live dummy validation | New review |
