...
| [`codex-mcp-tool-registration-incident-2026-06-08/issue-summary.md`](codex-mcp-tool-registration-incident-2026-06-08/issue-summary.md) | Incident summary for Codex plugin installed/enabled but Apple Mail MCP tools absent; fix and test plan for Claude plus Codex launcher compatibility | Active follow-up |
