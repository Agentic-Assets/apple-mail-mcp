...
|--------|---------|--------|
| [`active/identity-gate-and-search-date-window/`](active/identity-gate-and-search-date-window/) | Enforced public-repo identity-scan gate (AGENTIC-2358), `search_emails` subject-fast-path date-window fix (AGENTIC-2356), bounded-scan fallback conversion (AGENTIC-2355, 2 of 7 sites), and the package-wide bounded-scan lint widening | Committed at `055a968`, PR [#90](https://github.com/Agentic-Assets/apple-mail-mcp/pull/90) open and unmerged. Release gate green, live-verified on a 24K Exchange mailbox. Closeout and forward queue dated 2026-08-17 in the folder |
