...
**Current branch:** `fix/apple-mail-linear-backlog-20260731` (from `main` @ `2d03487`).

**Active implementation:** [`tasks/active/linear-backlog-2026-07-31/`](active/linear-backlog-2026-07-31/). Follow [`handoff-2026-07-31.md`](active/linear-backlog-2026-07-31/handoff-2026-07-31.md): finish review and local release verification for the bounded Linear backlog fixes, then record exact evidence on the affected issues. Do not merge without Cayman's new literal approval phrase.
...
**Next action:** finish adversarial review and local release verification for the Linear backlog branch, then attach the branch, full SHA, exact checks, and deferred live gates to each affected issue. Keep AGENTIC-781's human-operated native-reply checks open. AGENTIC-1093 and AGENTIC-842 remain founder-controlled, and AGENTIC-1191 needs a fresh sanitized reproduction before implementation.
