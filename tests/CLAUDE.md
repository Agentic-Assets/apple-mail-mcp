...
Mocked unit tests for the Apple Mail MCP server. Run `.venv/bin/pytest tests/ --collect-only -q` for the current total (800+ as of 2026-06). CI runs on Ubuntu with no Mail.app — every test mocks AppleScript or tests pure Python.
