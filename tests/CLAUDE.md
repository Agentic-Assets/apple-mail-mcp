...
Mocked unit tests for the Apple Mail MCP server. **798 tests + 30 subtests** (`pytest tests/ --collect-only -q`). CI runs on Ubuntu with no Mail.app — every test mocks AppleScript or tests pure Python.
